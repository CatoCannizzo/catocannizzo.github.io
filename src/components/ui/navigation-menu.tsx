...
const NavigationMenu = React.forwardRef<
  ...
  NavBarItemProps
>(({ className, isVert, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ...
    {...props}>
    {children}
    <NavigationMenuViewport isVert={isVert} />
  </NavigationMenuPrimitive.Root>
));
...
const NavigationMenuViewport = React.forwardRef<
  ...
  NavBarMenuViewProps
>(({ className, isVert, ...props }, ref) => (
  // right-full top-0 = left-0 top-full
  <div
    className={cn(
